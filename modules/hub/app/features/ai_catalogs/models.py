...
class AICatalog(Base, UUIDMixin, TimestampMixin):
    ...
    short_refresh_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    short_refresh_cycle_minutes: Mapped[int] = mapped_column(Integer, nullable=False, default=300)
    long_refresh_cycle_minutes: Mapped[int] = mapped_column(Integer, nullable=False, default=10080)
