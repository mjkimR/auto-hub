...
from app.features.projects.schemas import TemplateId, TemplateRead

TEMPLATE_VERSION = "1.0.0"
TEMPLATE_ROOT = Path(__file__).resolve().parents[5] / "templates" / "github-actions"
...
def list_templates() -> list[TemplateRead]:
    return [
        TemplateRead(
            ...
            changelog="Initial PR-only workflow with read-only lint/test commands and bounded execution.",
            required_jobs=jobs,
            filename="ci.yml",
