...
from app.features.execution.tasks.domains.appointment_chain.calendar.base import CalendarPort
from app.features.execution.tasks.domains.appointment_chain.calendar.fake import shared_fake_client
...
def get_calendar_client(settings: CalendarSettings | None = None) -> CalendarPort:
    ...
    if backend == "google":
        ...
        from app.features.execution.tasks.domains.appointment_chain.calendar.google import GoogleCalendarClient
