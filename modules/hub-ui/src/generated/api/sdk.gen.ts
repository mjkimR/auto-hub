 ...
 */
export const enrollPullRequestApiV1ProjectsProjectIdRunsPost = <ThrowOnError extends boolean = false>(options: Options<EnrollPullRequestApiV1ProjectsProjectIdRunsPostData, ThrowOnError>) => (options.client ?? client).post<EnrollPullRequestApiV1ProjectsProjectIdRunsPostResponses, EnrollPullRequestApiV1ProjectsProjectIdRunsPostErrors, ThrowOnError>({
    security: [{ name: 'X-API-Key', type: 'apiKey' }],
